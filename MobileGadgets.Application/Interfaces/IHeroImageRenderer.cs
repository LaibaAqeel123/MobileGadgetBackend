...
public interface IHeroImageRenderer
{
    ...
    /// using the given Scene's camera/lighting/colour setup. Returns PNG bytes, uncompressed/lossless.</summary>
    Task<byte[]> RenderAsync(Stream baseImage, Stream designMask, Stream cameraMask, Stream overlay, Stream design, Scene scene);
}
